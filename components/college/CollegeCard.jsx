...
export default function CollegeCard({
        ...
        <div className="p-5 flex-1 flex flex-col justify-between">
            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <h3 className="text-base sm:text-lg font-bold text-brand-dark group-hover:text-brand-teal transition-colors">
                  <Link href={detailUrl}>{college.name}</Link>
                </h3>
              </div>
          ...
          <div className="mt-5 pt-3 border-t border-brand-border/60 flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <Button href={`${detailUrl}#enquiry-section`} variant="primary" size="sm">
                Admission Help
              </Button>
            </div>
          </div>
  ...
  return (
    <article
      ...
      className="group border border-brand-border bg-white rounded hover:border-brand-teal hover:shadow-subtle transition-all duration-200 overflow-hidden flex flex-col justify-between"
    >
      <div>
        {/* Cover Photo */}
