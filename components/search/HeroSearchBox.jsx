  ...
  return (
    <div className="w-full max-w-4xl mx-auto">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-1.5 text-xs text-brand-gray">
        ...
        <button
          type="button"
          onClick={() => router.push('/colleges/btech')}
        ...
        <button
          type="button"
          onClick={() => router.push('/locations/jaipur')}
          className="border border-brand-border bg-white hover:border-brand-teal hover:text-brand-teal px-2.5 py-1 rounded-sm text-xs transition-colors"
        >
          Colleges in Jaipur
        </button>
        <button
          type="button"
          onClick={() => router.push('/colleges/mba')}
          className="border border-brand-border bg-white hover:border-brand-teal hover:text-brand-teal px-2.5 py-1 rounded-sm text-xs transition-colors"
        >
          Top MBA Colleges
        </button>
        <button
          type="button"
          onClick={() => router.push('/locations/delhi')}
          className="border border-brand-border bg-white hover:border-brand-teal hover:text-brand-teal px-2.5 py-1 rounded-sm text-xs transition-colors"
        >
          Colleges in Delhi
        </button>
        <button
          type="button"
          onClick={() => router.push('/locations/bangalore')}
          className="border border-brand-border bg-white hover:border-brand-teal hover:text-brand-teal px-2.5 py-1 rounded-sm text-xs transition-colors"
        >
