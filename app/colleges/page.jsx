          ...
          <div className="lg:hidden fixed inset-0 z-50 bg-black/50 p-4 flex items-center justify-center">
            <div className="bg-white rounded-md p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={() => setMobileFilterOpen(false)} className="text-gray-500 font-bold">✕</button>
              </div>
              <CollegeFilters
                filters={filters}
                onFilterChange={handleFilterChange}
...
export default function CollegesPage() {
  return (
    <Suspense fallback={<div className="py-20 text-center text-sm text-brand-gray">Loading directory...</div>}>
