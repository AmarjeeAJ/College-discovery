        ...
        <div className="flex items-center gap-3">
          ...
          {selectedColleges.length > 0 && (
            <button
              ...
              className="text-xs text-brand-gray hover:text-red-600 underline font-medium cursor-pointer"
            >
              Clear Comparison
            </button>
          )}
      ...
      {selectedColleges.length === 0 ? (
        ...
        <div className="border border-brand-border bg-white rounded p-12 text-center space-y-4 max-w-xl mx-auto my-12">
          ...
          <div className="pt-2 flex justify-center gap-3">
            ...
            <Button href="/colleges" variant="outline" size="md">
              Browse Directory
            </Button>
          </div>
        </div>
                  ...
                  {selectedColleges.map((col) => (
                    <td key={col.id} className="p-4 border-r border-brand-border last:border-r-0">
                      <div className="space-y-2">
                        ...
                        <Button
                          href={`/college/${col.slug}#enquiry-section`}
                          variant="outline"
                          size="sm"
            ...
            {availableColleges.map((c) => (
              ...
              >
                ...
                <button
                  ...
                  className="bg-brand-teal text-white hover:bg-brand-teal-dark px-2.5 py-1 rounded text-xs font-semibold shrink-0 cursor-pointer"
                >
                  Add
                </button>
              </div>
