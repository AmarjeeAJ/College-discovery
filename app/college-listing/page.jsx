  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiService.submitEnquiry({
        ...
        course: `${formData.institutionType} (${formData.accreditation})`,
        preferredLocation: `${formData.city}, ${formData.state}`,
        preferredCollege: formData.collegeName,
        message: `[Institutional College Listing Request] Established: ${formData.establishedYear} | Website: ${formData.website} | Designation: ${formData.designation} | Flagship Courses: ${formData.flagshipCourses} | Notes: ${formData.message}`
      });
