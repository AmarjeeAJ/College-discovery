...
export default function FAQPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      <SEO
        title="Frequently Asked Questions (FAQ) - Admissions, Fees & Counselling 2026"
        description="Got questions about college shortlisting, fee schedules, JoSAA choice filling, or student counselling? Find answers here."
        canonical="https://theshineeducation.com/faq"
      />
