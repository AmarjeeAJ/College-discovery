import { ShieldCheck, Users, Award, BookOpen, MapPin, CheckCircle } from 'lucide-react';
...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      <SEO
        title="About Us: Educational Discovery & Student Advisory"
        ...
        canonical="https://theshineeducation.com/about"
      />
      ...
      <section className="border border-brand-border bg-brand-teal-light/40 rounded p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
        ...
        <Button to="/counselling" variant="primary" size="md" className="shrink-0">
