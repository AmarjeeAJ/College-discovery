...
import { Search, Building2, BookOpen, MapPin, Award, ArrowRight } from 'lucide-react';
...
export default function SearchResultsPage() {
  ...
  const [activeTab, setActiveTab] = useState('all'); // 'all', 'colleges', 'courses', 'locations'
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      <SEO
        title={query ? `Search results for "${query}" | College Discovery` : 'Search Colleges, Courses & Locations'}
        description="Search through 1,200+ colleges, courses, locations, and entrance examinations across India."
      />
      ...
      {loading ? (
        ...
        <div className="border border-brand-border bg-white rounded p-12 text-center space-y-4 max-w-xl mx-auto">
          ...
          <Button to="/colleges" variant="primary" size="md">
            Browse All Colleges
          </Button>
        </div>
      ) : (
