...
import { FileText, Calculator, Download, HelpCircle, ArrowRight, ShieldCheck, Award } from 'lucide-react';
...
export default function ResourcesPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-12">
      <SEO
        title="Student Resources, Cutoff Predictors & Downloadable Guides 2026"
        ...
        canonical="https://theshineeducation.com/resources"
      />
          ...
          {tools.map((t, idx) => (
            <div key={idx} className="border border-brand-border bg-white rounded p-6 flex flex-col justify-between space-y-4">
              ...
              <div className="pt-3 border-t border-brand-border/60">
                <Button to={t.link} variant="outline" size="sm" icon={ArrowRight} iconPosition="right" className="w-full">
                  {t.action}
                </Button>
              </div>
            </div>
