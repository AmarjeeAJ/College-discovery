...
export default function BlogListingPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 space-y-10">
      <SEO
        title="Education Blog & Admission Counsel Articles (2026 Advice Desk)"
        description="Read in-depth college admission analysis, engineering vs core comparisons, placement audits, and counselling insights."
        canonical="https://theshineeducation.com/blog"
      />
