      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400 list-none p-0 m-0">
              ...
              <li>
                <Link to="/colleges/btech" className="hover:text-white transition-colors">
                  Engineering & B.Tech
                </Link>
              </li>
              <li>
                <Link to="/colleges/mba" className="hover:text-white transition-colors">
                  Management & MBA
                </Link>
              </li>
              <li>
                <Link to="/colleges/medical" className="hover:text-white transition-colors">
                  Medical Colleges
                </Link>
              </li>
              <li>
                <Link to="/colleges/law" className="hover:text-white transition-colors">
                  Law Colleges
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400 list-none p-0 m-0">
              <li>
                <Link to="/courses/btech" className="hover:text-white transition-colors">
                  B.Tech / B.E.
                </Link>
              </li>
              <li>
                <Link to="/courses/computer-science" className="hover:text-white transition-colors">
                  Computer Science
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400 list-none p-0 m-0">
              <li>
                <Link to="/locations/jaipur" className="hover:text-white transition-colors">
                  Colleges in Jaipur
                </Link>
              </li>
              <li>
                <Link to="/locations/delhi" className="hover:text-white transition-colors">
                  Colleges in Delhi NCR
                </Link>
              </li>
              <li>
                <Link to="/locations/bangalore" className="hover:text-white transition-colors">
                  Colleges in Bangalore
                </Link>
              </li>
              <li>
                <Link to="/locations/mumbai" className="hover:text-white transition-colors">
                  Colleges in Mumbai
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm text-gray-400 list-none p-0 m-0">
              ...
              <li>
                <Link to="/college-listing" className="text-brand-teal hover:text-white font-medium transition-colors">
                  List Your College
                </Link>
              </li>
              <li>
                <Link to="/college-listing" className="hover:text-white transition-colors">
                  Partner With Us
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          ...
          <div className="flex flex-wrap gap-2 text-xs text-gray-400">
            <Link to="/colleges/btech" className="hover:text-brand-teal transition-colors">
              B.Tech Colleges in India
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/locations/jaipur" className="hover:text-brand-teal transition-colors">
              Engineering Colleges in Jaipur
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/colleges/mba" className="hover:text-brand-teal transition-colors">
              Top MBA Colleges
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/locations/delhi" className="hover:text-brand-teal transition-colors">
              B.Tech Colleges in Delhi NCR
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/locations/bangalore" className="hover:text-brand-teal transition-colors">
              Private Engineering Colleges Bangalore
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/courses/computer-science" className="hover:text-brand-teal transition-colors">
              Computer Science Placements
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/exams" className="hover:text-brand-teal transition-colors">
              JEE Main 2026 Cutoff
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/compare" className="hover:text-brand-teal transition-colors">
              College Comparison Tool
            </Link>
            <span className="text-gray-700">•</span>
            <Link to="/college-listing" className="text-brand-teal hover:underline transition-colors font-medium">
